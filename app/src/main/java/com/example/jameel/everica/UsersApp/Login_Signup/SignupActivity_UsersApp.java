...
import com.example.jameel.everica.UsersApp.Helpers.ProfileInfoHelper_UsersApp;
...
public class SignupActivity_UsersApp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_alreadyAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(SignupActivity_UsersApp.this, LoginwithEmailActivity_UserApp.class);
        ...
        button_SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name)) {
                    ...
                    Toast.makeText(SignupActivity_UsersApp.this, "Please Enter Your name", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(email)) {

                    Toast.makeText(SignupActivity_UsersApp.this, "Please Enter Your Email", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(contact_no)) {

                    Toast.makeText(SignupActivity_UsersApp.this, "Please Enter Your name Phone no", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(password)) {

                    Toast.makeText(SignupActivity_UsersApp.this, "Please Enter Your password", Toast.LENGTH_SHORT).show();
                }
                if (TextUtils.isEmpty(confirm_password)) {

                    Toast.makeText(SignupActivity_UsersApp.this, "Please Enter Your Confirm password", Toast.LENGTH_SHORT).show();
                }
...
//                }
                                        ...
                                        databaseReference.child(firebaseAuth.getCurrentUser().getUid())
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(SignupActivity_UsersApp.this, "Your Account Is Created\n" + email + "\n" + password, Toast.LENGTH_SHORT).show();
                                                    progressDialog.dismiss();

                                                    Intent intent1 = new Intent(SignupActivity_UsersApp.this,
                                                            LoginwithEmailActivity_UserApp.class);
                                                    startActivity(intent1);
                    ...
                    databaseReference
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(SignupActivity_UsersApp.this, " data save in userprofile \n" + email + "\n" + password, Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                ...
                {
                    Toast.makeText(SignupActivity_UsersApp.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
